...
contract FreedomCash is ERC20 {
    ...
    uint256 public nextCULTBurnAfterXMoreWrites = 369;
    ...
    function write(address freedomWallet, string memory text) public {
        ...
        uint256 slippage = cultAmountToBeBurned * 45000;

        nextCULTBurnAfterXMoreWrites = counter % 369;

        if (nextCULTBurnAfterXMoreWrites == 0) {
            Liquidity.swap(
                address(this),
                cultAddress,
